...
nrc.sent<-get_sentences(sentiment_by(cmmnt_df$comments, list(id), lexicon="nrc"))
nrc.sent.t<-get_sentences(sentiment_by(cmmnt_df$comments, list(id), lexicon="nrc"))
...
toxic.lr<-glm(toxic~swear_sent+hate_sent+length+ncap+ncap_len+nexcl+nquest+npunct_len+nsent+nsymb+nwords+nhate+afinn+NRC,data=toxic_train, family= binomial)

...
sparsetrain = Matrix(as.matrix(train[3:25]), sparse = TRUE)
sparsetest = Matrix(as.matrix(test[3:25]), sparse = TRUE)
...
severe_toxicpreds = ifelse(severe_toxicpreds > 0.017, 1 ,0)
...
insultpreds = ifelse(insultpreds > 0.4, 1 ,0)

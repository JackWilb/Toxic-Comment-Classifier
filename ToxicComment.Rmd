...
set.seed(999)
#train = read_csv("E:/Rstudio/Toxic-Comment-Classifier/train.csv")
train = read_csv("~/Programming/Rstudio/Toxic-Comment-Classifier/train.csv")
...
```{r}
toxicglm = cv.glmnet(as.matrix(train[10:20]), 
                     train$toxic, 
                     alpha = 0, 
                     family = "binomial", 
                     type.measure = "auc",
                     ...
                     standardize = T,
                     nlambda = 50)
toxicpreds = predict(toxicglm, as.matrix(test[10:20]))
toxicpreds = ifelse(toxicpreds > 0.5, 1 ,0)
confusionMatrix(toxicpreds, test$toxic)

severe_toxicglm = cv.glmnet(as.matrix(train[10:20]), 
                     train$severe_toxic, 
                     alpha = 0, 
                     family = "binomial", 
                     type.measure = "auc",
                     ...
                     standardize = T,
                     nlambda = 50)
severe_toxicpreds = predict(severe_toxicglm, as.matrix(test[10:20]))
severe_toxicpreds = ifelse(severe_toxicpreds > 0.5, 1 ,0)
confusionMatrix(severe_toxicpreds, test$severe_toxic)

insultglm = cv.glmnet(as.matrix(train[10:20]), 
                     train$insult, 
                     alpha = 0, 
                     family = "binomial", 
                     type.measure = "auc",
                     ...
                     standardize = T,
                     nlambda = 50)
insultpreds = predict(insultglm, as.matrix(test[10:20]))
insultpreds = ifelse(insultpreds > 0.5, 1 ,0)
confusionMatrix(insultpreds, test$insult)

obsceneglm = cv.glmnet(as.matrix(train[10:20]), 
                     train$obscene, 
                     alpha = 0, 
                     family = "binomial", 
                     type.measure = "auc",
                     ...
                     standardize = T,
                     nlambda = 50)
obscenepreds = predict(obsceneglm, as.matrix(test[10:20]))
...
identity_hateglm = cv.glmnet(as.matrix(train[10:20]), 
                     train$identity_hate, 
                     alpha = 0, 
                     family = "binomial", 
                     type.measure = "auc",
                     ...
                     standardize = T,
                     nlambda = 50)
identity_hatepreds = predict(identity_hateglm, as.matrix(test[10:20]))
